<template>
  <div class="min-w-screen h-screen animated fadeIn faster fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover" id="modal-id">
    ...
    <div class="w-full  md:max-w-lg p-5  relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
      <div class="">
        <!--body-->
  ...
  <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
        ...
        <div class="p-3  mt-2 text-center space-x-4 md:block">
            <button @click.prevent="onClose" class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100">
                Cancel
            </button>
...
export default {
  name: "Modal",
  mounted(){
    console.log('test',this.$store.getters['modal/getData'])
  },
  created() {
